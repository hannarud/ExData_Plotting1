...
plot(plotdata$DateTime, plotdata$Voltage, type= "l", lwd=1,
     ylab= "Voltage", xlab="datetime")
plot(plotdata$DateTime, plotdata$Sub_metering_1, type= "l", lwd=1,
     col = "black", ylab= "Energy sub metering", xlab="")
lines(plotdata$DateTime, plotdata$Sub_metering_2, type= "l", lwd=1,
      col = "red")
lines(plotdata$DateTime, plotdata$Sub_metering_3, type= "l", lwd=1,
      col = "blue")
legend("topright", lty = 1, col = c("black", "red", "blue"), bty = "n",
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
plot(plotdata$DateTime, plotdata$Global_reactive_power, type= "l", lwd=1,
